...
pub fn run(project_dir: &Path) -> Result<(), String> {
    ...
    if !citation_path.exists() {
        let project_name = project_dir
            ...
            .unwrap_or_default()
            .to_string_lossy();
        let author_name = git_name.as_deref().unwrap_or("Your Name");
        let author_email = git_email.as_deref().unwrap_or("your.email@example.com");
...
license: Apache-2.0
date-released: "{}"
repository-code: "https://codeberg.org/YOUR-ORG/{}"
abstract: "A brief description of the software."
keywords:
  - research-software
"#,
            project_name, family, given, author_email, today, project_name
        );
